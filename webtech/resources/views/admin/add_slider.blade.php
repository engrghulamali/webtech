                ...
                <form method="post" name="frm" action="{{ url('add-team') }}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
                 {{ csrf_field() }}
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="button_text" class="form-control col-md-7 col-xs-12" value="{{ old('button_text') }}" />
                        </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="last-name">Banner Pitcher <span class="required">*</span>
                        </label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
