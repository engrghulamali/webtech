...
<div role="main">
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                <form method="post" name="frm" action="{{ url('edit-team/'.$teamDetails->id) }}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate> {{ csrf_field() }}
                    @if($errors->any())
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="name" required="required" class="form-control col-md-7 col-xs-12" value="{{ $teamDetails->name }}" />
                        </div>
                    </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="email" required="required" class="form-control col-md-7 col-xs-12" value="{{ $teamDetails->email }}" />
                        </div>
                    </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="phone" required="required" class="form-control col-md-7 col-xs-12" value="{{ $teamDetails->phone }}" />
                        </div>
                    </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="skype" required="required" class="form-control col-md-7 col-xs-12" value="{{ $teamDetails->skype }}" />
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                             <input type="text" name="linkedin" class="form-control col-md-7 col-xs-12" value="{{ $teamDetails->linkedin }}" />
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="position" class="form-control col-md-7 col-xs-12" value="{{ $teamDetails->position }}" />
                        </div>
                    </div>
