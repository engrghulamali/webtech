...
@section('content')
    <div role="main">
      <div class="x_content content">
        ...
        <div class="x_content">
          <div class="x_panel">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="#" novalidate="novalidate"> {{ csrf_field() }}
              @if($errors->any())
              ...
              <div class="item form-group">
                  ...
                  <div class="col-md-7 col-sm-7 col-xs-12">
                      <input type="text" name="link" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('link') }}" />
                  </div>
              </div>
              <div class="item form-group">
                  ...
                  <div class="col-md-7 col-sm-7 col-xs-12">
                      <textarea name="description" required="required" class="form-control col-md-7 col-xs-12">{{ old('description') }}</textarea>
                  </div>
              </div>
              <div class="item form-group">
...
<script src="{{ url('assets/admin/admin_js/validator/validator.js') }}"></script>
<script>
