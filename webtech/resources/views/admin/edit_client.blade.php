...
<div role="main">
    <div class="x_content content">
        ...
        <div class="x_content">
            <div class="x_panel">
                <form method="post" name="frm" action="{{ url('edit-client/'.$clientDetails->id) }}" id="demo-form2" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate> {{ csrf_field() }}
                    @if($errors->any())
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" name="title" required="required" class="form-control col-md-7 col-xs-12" value="{{ $clientDetails->title }}" />
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="text" id="link" name="link" class="form-control col-md-7 col-xs-12" value="{{ $clientDetails->link }}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <img width="100px" height="100px" src="{{ asset('/images/clients/'.$clientDetails->image) }}">
                        </div>
                    </div>
                    @endif
                        <div class="item form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <textarea name="description" class="form-control col-md-7 col-xs-12">{{ $clientDetails->description }}</textarea>
                        </div>
                    </div>
